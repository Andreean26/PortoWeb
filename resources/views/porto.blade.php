...
<head>
    ...
    <link href="{{ asset('porto/lib/animate/animate.min.css') }}" rel="stylesheet">
    <link href="{{ asset('porto/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">
    <link href="{{ asset('porto/lib/lightbox/css/lightbox.min.css') }}" rel="stylesheet">
        ...
        <div class="about wow fadeInUp" data-wow-delay="0.1s" id="about">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img src="porto/img/about.jpg" alt="Image">
                        </div>
                    </div>
                    <div class="col-lg-6">
...
{{-- @foreach ($portofolios as $item) --}}
    ...
    <script src="{{ asset('porto/lib/easing/easing.min.js') }}"></script>
    <script src="{{ asset('porto/lib/wow/wow.min.js') }}"></script>
    <script src="{{ asset('porto/lib/waypoints/waypoints.min.js') }}"></script>
    <script src="{{ asset('porto/lib/typed/typed.min.js') }}"></script>
    <script src="{{ asset('porto/lib/owlcarousel/assets/owl.carousel.min.css') }}"></script>
    <script src="{{ asset('porto/lib/isotope/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('porto/lib/lightbox/js/lightbox.min.js') }}"></script>
